...
public class RecyclerAdapterTrialBalance extends RecyclerView.Adapter<RecyclerAdapterTrialBalance.RecyclerHolder> {
    private TAccount[] groups;
    private Context context;

    public RecyclerAdapterTrialBalance(TAccount[] data, Context context) {
        this.groups = data;
